...
.\Deploy-SSRSProject.ps1 -Verbose -Path '\\vmdev-ssis.pmdev.local\c$\Users\jdgonzalez\Documents\Visual Studio 2010\Projects\Paymetric Solution\Paymetric Reporting\Paymetric Reporting.rptproj' -Configuration 'Debug' -Credential $cred
